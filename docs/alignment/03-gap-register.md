...
| GAP-026 | Partially remediated on `fix/aln-007-dual-collection-finance` | Mobile Admin now supports reconciliation evidence and settlement creation/finalization; dedicated commission-rate management remains pending |
...
| GAP-019 | Partially remediated on `feat/aln-010-staff-lifecycle` | Owner and assigned Hotel Manager can list and manage hotel staff through tuple-aware operations; delegated Manager mutations for hotel profile, room types, and physical-room setup remain pending |
